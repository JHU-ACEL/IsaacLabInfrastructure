...
from .ace_isaac_5_marl_env_cfg import AceIsaac5MarlEnvCfg


class AceIsaac5MarlEnv(DirectMARLEnv):
    cfg: AceIsaac5MarlEnvCfg

    def __init__(self, cfg: AceIsaac5MarlEnvCfg, render_mode: str | None = None, **kwargs):
