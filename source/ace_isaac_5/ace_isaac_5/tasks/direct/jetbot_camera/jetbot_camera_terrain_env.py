...
from .jetbot_camera_terrain_env_cfg import JetbotCameraTerrainEnvCfg

class JetbotCameraTerrainEnv(DirectRLEnv):
    cfg: JetbotCameraTerrainEnvCfg

    def __init__(self, cfg: JetbotCameraTerrainEnvCfg, render_mode: str | None = None, **kwargs):
