...
from ace_isaac_5.robots.jetbot import JETBOT_CONFIG
...
#from .mars_terrain import MarsTerrainSceneCfg
...
@configclass
class JetbotCameraTerrainEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 2
    ...
    goal_cfg = RigidObjectCfg(prim_path="/World/envs/env_.*/marker", spawn=sim_utils.UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Blocks/red_block.usd", scale = (3.0, 3.0, 3.0)), init_state=RigidObjectCfg.InitialStateCfg(pos=(2.1,-.3,1.0)))
